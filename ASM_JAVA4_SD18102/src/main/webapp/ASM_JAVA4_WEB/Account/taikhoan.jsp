...
<body>
  ...
  <div class="container-xl px-4 mt-4" style="max-width: 1200px; max-height: 800px;">
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2" src="/images/minhkhoi.jpg" alt="">
                    <!-- Profile picture help block-->
                    <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                    <!-- Profile picture upload button-->
                    
                    <button class="btn btn" type="button" style="background-color: #232946; color: white;">Upload new image</button>
                </div>
            </div>
        </div>
        <div class="col-xl-8">
                    ...
                    <form>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="email" type="text" placeholder="nhập email" >
                            </div>
                            <!-- Form Group (last name)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="password">Mật khẩu tài khoản:</label>
                                <input class="form-control" id="password" type="text" placeholder="nhập mật khẩu" >
                            </div>
                        </div>
                        <!-- Form Row        -->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="phone" type="text" placeholder="nhập số điện thoại">
                            </div>
                            <!-- Form Group (location)-->
                            <div class="col-md-6">
                        ...
                        <button class="btn btn" style="background-color: #232946; color: white;" type="button">Lưu</button>
